''' 
    this is a simple To_Do List application that lets users keep track of their daily activities for maximum productivity
    The users task details are stored in a database in order to avoid loss of data when the application is closed.
'''
...
# 'ADD Task' Button - window functionality
class adding_task_functionality():
    def adding_tasks():
        ...
        # Extracting and saving tasks in data base
...
# Task deletion and viewing functoinality
...
add_task_button.place(x = 170,y = 10)
